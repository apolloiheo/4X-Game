...
public class WorldGenWalkerTerrain : MonoBehaviour
{
    ...
    public WorldGenWalkerTerrain(World w, GameTile startTile, int _direction, int _oldBiome, int _newBiome) //initializing variables
    {
        world = w;
        CurrTile = startTile;
